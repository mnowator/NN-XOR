...
Container<Image> read_training_images(std::size_t limit, Functor func) {
    ...
    read_mnist_image_file<Container, Image>(images, "F:/QtProjects/NN-XOR/images.bin", limit, func);
    return images;
}
...
Container<Image> read_test_images(std::size_t limit, Functor func) {
    Container<Image> images;
    read_mnist_image_file<Container, Image>(images, "t10k-images-idx3-ubyte", limit, func);
    return images;
}
...
Container<Label> read_training_labels(std::size_t limit) {
    ...
    read_mnist_label_file<Container, Label>(labels, "F:/QtProjects/NN-XOR/labels.bin", limit);
    return labels;
}
...
Container<Label> read_test_labels(std::size_t limit) {
    Container<Label> labels;
    read_mnist_label_file<Container, Label>(labels, "t10k-labels-idx1-ubyte", limit);
    return labels;
}
